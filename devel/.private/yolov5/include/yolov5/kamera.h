// Generated by gencpp from file yolov5/kamera.msg
// DO NOT EDIT!


#ifndef YOLOV5_MESSAGE_KAMERA_H
#define YOLOV5_MESSAGE_KAMERA_H
...
struct kamera_
{
  ...
  typedef boost::shared_ptr< ::yolov5::kamera_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::yolov5::kamera_<ContainerAllocator> const> ConstPtr;

}; // struct kamera_

typedef ::yolov5::kamera_<std::allocator<void> > kamera;

typedef boost::shared_ptr< ::yolov5::kamera > kameraPtr;
typedef boost::shared_ptr< ::yolov5::kamera const> kameraConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::yolov5::kamera_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::yolov5::kamera_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::yolov5::kamera_<ContainerAllocator1> & lhs, const ::yolov5::kamera_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::yolov5::kamera_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::yolov5::kamera_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::yolov5::kamera_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::yolov5::kamera_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::yolov5::kamera_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::yolov5::kamera_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::yolov5::kamera_<ContainerAllocator> >
{
  ...
  static const char* value(const ::yolov5::kamera_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16489477eaaf0dbcULL;
  static const uint64_t static_value2 = 0xa582174d9a0d8936ULL;
};

template<class ContainerAllocator>
struct DataType< ::yolov5::kamera_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::yolov5::kamera_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::yolov5::kamera_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::yolov5::kamera_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::yolov5::kamera_<ContainerAllocator>& v)
  {

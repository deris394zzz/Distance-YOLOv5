...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolov5-msg:<BoundingBox> is deprecated: use yolov5-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'object_label-val :lambda-list '(m))
(cl:defmethod object_label-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:object_label-val is deprecated.  Use yolov5-msg:object_label instead.")
  (object_label m))

(cl:ensure-generic-function 'probability-val :lambda-list '(m))
(cl:defmethod probability-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:probability-val is deprecated.  Use yolov5-msg:probability instead.")
  (probability m))

(cl:ensure-generic-function 'xmin_cv-val :lambda-list '(m))
(cl:defmethod xmin_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:xmin_cv-val is deprecated.  Use yolov5-msg:xmin_cv instead.")
  (xmin_cv m))

(cl:ensure-generic-function 'ymin_cv-val :lambda-list '(m))
(cl:defmethod ymin_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:ymin_cv-val is deprecated.  Use yolov5-msg:ymin_cv instead.")
  (ymin_cv m))

(cl:ensure-generic-function 'xmax_cv-val :lambda-list '(m))
(cl:defmethod xmax_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:xmax_cv-val is deprecated.  Use yolov5-msg:xmax_cv instead.")
  (xmax_cv m))

(cl:ensure-generic-function 'ymax_cv-val :lambda-list '(m))
(cl:defmethod ymax_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:ymax_cv-val is deprecated.  Use yolov5-msg:ymax_cv instead.")
  (ymax_cv m))

(cl:ensure-generic-function 'xcenter_cv-val :lambda-list '(m))
(cl:defmethod xcenter_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:xcenter_cv-val is deprecated.  Use yolov5-msg:xcenter_cv instead.")
  (xcenter_cv m))

(cl:ensure-generic-function 'ycenter_cv-val :lambda-list '(m))
(cl:defmethod ycenter_cv-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:ycenter_cv-val is deprecated.  Use yolov5-msg:ycenter_cv instead.")
  (ycenter_cv m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:width-val is deprecated.  Use yolov5-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5-msg:height-val is deprecated.  Use yolov5-msg:height instead.")
  (height m))

...
message(STATUS "yolov5: 4 messages, 0 services")

set(MSG_I_FLAGS "-Iyolov5:/home/user/projek-kamera/src/yolov5/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/user/projek-kamera/src/yolov5/msg/BoundingBox.msg" NAME_WE)
add_custom_target(_yolov5_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov5" "/home/user/projek-kamera/src/yolov5/msg/BoundingBox.msg" ""
)

get_filename_component(_filename "/home/user/projek-kamera/src/yolov5/msg/BoundingBoxes.msg" NAME_WE)
add_custom_target(_yolov5_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov5" "/home/user/projek-kamera/src/yolov5/msg/BoundingBoxes.msg" "yolov5/BoundingBox"
)

get_filename_component(_filename "/home/user/projek-kamera/src/yolov5/msg/kamera.msg" NAME_WE)
add_custom_target(_yolov5_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov5" "/home/user/projek-kamera/src/yolov5/msg/kamera.msg" ""
)

get_filename_component(_filename "/home/user/projek-kamera/src/yolov5/msg/vision.msg" NAME_WE)
add_custom_target(_yolov5_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov5" "/home/user/projek-kamera/src/yolov5/msg/vision.msg" ""
)
